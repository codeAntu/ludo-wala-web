...
const reviews = [
  ...
  {
    review:
      'I earned over ₹50,000 in Ludo Wala App. It has an easy-to-use interface that motivates you to play more and earn big!',
  ...
  {
    review:
      'Main pichle 2 saal se Ludo Wala App pe khel raha hu. Maine ₹10,000 se zyaada jeeta hai iss pe. 100% safe aur secure hai ye app!',
    name: 'Alok Behera',
    won: '₹12,765',
  ...
  {
    review: 'I love spending my free time on Ludo Wala App. It is an excellent platform to play games and win money.',
    name: 'Rajesh Sharma',
    won: '₹54,356',
  ...
  {
    review:
      ' Ludo Wala  App mein ₹70,000 se zyaada jeeta hai. Iss app ka graphics best hai jo gaming experience ko acha karta hai!',
    name: 'Aman Kumar',
    won: '₹74,356',
